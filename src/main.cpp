...
#if defined(NDEBUG)
# error "CEED cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "CEED Signed Message:\n";
...
if(pindexBest->nHeight+1 >= 1 && pindexBest->nHeight+1 <= 10)
        {
            nSubsidy = 5000000 * COIN; // 50M coins
        }
